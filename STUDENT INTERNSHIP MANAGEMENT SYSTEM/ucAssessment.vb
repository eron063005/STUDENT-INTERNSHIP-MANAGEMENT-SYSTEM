...
Public Class ucAssessment
    ...
    Private Sub LoadAssessmentData()
        ...
        ' Use a different variable name or remove duplicate Dim
        Dim sql As String = "SELECT a.AssessmentId, a.StudentId, a.CompanyContactId, a.AssessmentGrade, a.Archived
                     FROM assessment a
