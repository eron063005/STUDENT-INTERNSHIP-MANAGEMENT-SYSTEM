...
Partial Class Dashboard
    ...
    Private Sub InitializeComponent()
        ...
        LogOut.FlatAppearance.MouseDownBackColor = Color.FromArgb(CByte(122), CByte(141), CByte(158))
        LogOut.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(122), CByte(141), CByte(158))
        LogOut.FlatStyle = FlatStyle.Flat
        LogOut.Image = My.Resources.Resources.Log_Out
        LogOut.Location = New Point(1406, 54)
        LogOut.Name = "LogOut"
        LogOut.Size = New Size(72, 86)
        LogOut.TabIndex = 9
